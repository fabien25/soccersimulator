...
strat_j1.add('a',Gardien_static())
strat_j1.add('z',Passeur())
team1.add("Jexp 1",strat_j1)
team1.add("Jexp 2",Campeur_static())
...
def jouer_arbre(dt):
    ...
    dic = {"Gardien_static":Gardien_static(),"Passeur":Passeur()}
    ...
    team3.add("Joueur 2",Campeur_static())
